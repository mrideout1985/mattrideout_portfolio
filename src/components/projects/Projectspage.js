...
function Projectspage() {
    return (
        <div className={styles["container"]}>
            ...
            <div className={styles["container__project"]}><a href="https://sleepy-dubinsky-af7051.netlify.com/"><img src={weather} alt="Weather Project" /></a>
                <div className={styles["container__description"]}>A project I made using OpenWeather API to fetch the weather at any location.
            </div></div>
            <div className={styles["container__project"]}><a href="https://vibrant-hypatia-cad447.netlify.com/"><img src={bmi} /> </a><div className={styles["container__description"]}>A calculator that gets your BMI (Body Mass Index) based on your height and weight
            </div></div>
        </div>
    );
}
